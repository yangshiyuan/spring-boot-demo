CREATE DATABASE spring_boot_jdbc_cache;

USE spring_boot_jdbc_cache;

CREATE TABLE city (
id bigint(20) NOT NULL AUTO_INCREMENT COMMENT '城市id',
country varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '所属国家',
name varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '城市名称',
state varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '所属州',
map varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '经纬度',
PRIMARY KEY (id)
...
name varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '酒店名称',
address varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '酒店地址',
zip varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '邮编',
PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
idx bigint(30) NOT NULL COMMENT '针对某个酒店的评论idx',
check_in_date date NOT NULL COMMENT '入住日期',
rating int(10) NOT NULL COMMENT '等级',
trip_type int(10) NOT NULL COMMENT '旅行类型',
title varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '标题',
details varchar(5000) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '详情',
PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
